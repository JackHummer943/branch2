// Описать класс для работы со сторокой, как со стандартным типом данных
// В разделе описания элементов-данных класс должен иметь переменую для хранения символов строки.
...
{
  if ((strcmp(str, s.str)) == 0) // Сравним символьные массивы
    return 1;
  else
    return 0;
}
...
void Stroka::vvod() // ввод строки c клавиатуры
{
